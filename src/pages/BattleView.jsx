...
import { battleService, useAuth, likeService, viewService } from "../services/firebase"; // Сгруппировал импорты для чистоты
...
export default function BattleView() {
  ...
  const hasPages = battle.pages && battle.pages.length > 0;
